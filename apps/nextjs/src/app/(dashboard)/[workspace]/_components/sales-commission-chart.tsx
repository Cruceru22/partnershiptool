...
const defaultPlatformData: DataPoint[] = [
  ...
  { name: "rakuten", sales: 0, commission: 0, transactions: 0 }
];
  ...
  return (
    <div className="space-y-8">
      ...
      <ChartContainer 
        ...
        subtitle="Monthly sales and commission across all affiliate networks"
        className="h-80"
      >
      ...
      <ChartContainer 
        ...
        subtitle="Monthly transaction count across all affiliate networks"
        className="h-64"
      >
