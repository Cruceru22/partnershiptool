(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_media-captions_dist_cb689253._.js", {

"[project]/node_modules/media-captions/dist/dev.js [app-client] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/media-captions/dist/dev.js [app-client] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";

var { g: global, d: __dirname } = __turbopack_context__;
{
__turbopack_context__.s({});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/media-captions/dist/dev.js [app-client] (ecmascript) <locals>");
}}),
"[project]/node_modules/media-captions/dist/dev/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    ...
    "g": (()=>parseTextStream),
    "h": (()=>VTTRegion),
    "i": (()=>createVTTCueTemplate),
    "j": (()=>renderVTTTokensString),
    "p": (()=>parseVTTTimestamp),
    "r": (()=>renderVTTCueString),
    "t": (()=>tokenizeVTTCue),
    "u": (()=>updateTimedVTTCueNodes)
});
...
async function parseTextStream(stream, options) {
    ...
    if (typeof type === "string") {
        switch(type){
            case "srt":
                factory = (await __turbopack_context__.r("[project]/node_modules/media-captions/dist/dev/srt-parser.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i)).default;
                break;
            case "ssa":
            case "ass":
                factory = (await __turbopack_context__.r("[project]/node_modules/media-captions/dist/dev/ssa-parser.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i)).default;
                break;
            default:
...
class VTTParser {
    ...
    async init(init) {
        ...
        if (init.errors) this._errorBuilder = (await __turbopack_context__.r("[project]/node_modules/media-captions/dist/dev/errors.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i)).ParseErrorBuilder;
    }
...
function createVTTCueTemplate(cue) {
    if (IS_SERVER) {
        throw Error("[media-captions] called `createVTTCueTemplate` on the server - use `renderVTTCueString`");
    }
...
function avoidBoxCollisions(container, box, boxes, axis) {
    let percentage = 1, positionedBox, startBox = {
        ...box
    };
...
function positionCue(container, cue, displayEl, boxes) {
    ...
    if (displayEl[POSITION_OVERRIDE]) {
        axis = [
            displayEl[POSITION_OVERRIDE] === "top" ? "+y" : "-y",
            "+x",
            "-x"
        ];
...
class CaptionsRenderer {
    ...
    _render(forceUpdate = false) {
        ...
        let cue, activeCues = [
            ...this._cues.keys()
        ].filter((cue2)=>this._currentTime >= cue2.startTime && this._currentTime <= cue2.endTime).sort((cueA, cueB)=>cueA.startTime !== cueB.startTime ? cueA.startTime - cueB.startTime : cueA.endTime - cueB.endTime), activeRegions = activeCues.map((cue2)=>cue2.region);
...
"[project]/node_modules/media-captions/dist/dev.js [app-client] (ecmascript) <exports>": ((__turbopack_context__) => {
"use strict";

var { g: global, d: __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "CaptionsRenderer": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]),
    "ParseError": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["P"]),
    "ParseErrorCode": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"]),
    "TextCue": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"]),
    "VTTCue": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["b"]),
    "VTTRegion": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"]),
    "createVTTCueTemplate": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["i"]),
    "parseByteStream": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"]),
    "parseResponse": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["d"]),
    "parseText": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["f"]),
    "parseTextStream": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"]),
    "parseVTTTimestamp": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["p"]),
    "renderVTTCueString": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["r"]),
    "renderVTTTokensString": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["j"]),
    "tokenizeVTTCue": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"]),
    "updateTimedVTTCueNodes": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["u"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/media-captions/dist/dev/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/media-captions/dist/dev.js [app-client] (ecmascript) <locals>");
}}),
"[project]/node_modules/media-captions/dist/dev.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, d: __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "CaptionsRenderer": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["CaptionsRenderer"]),
    "ParseError": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["ParseError"]),
    "ParseErrorCode": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["ParseErrorCode"]),
    "TextCue": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["TextCue"]),
    "VTTCue": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["VTTCue"]),
    "VTTRegion": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["VTTRegion"]),
    "createVTTCueTemplate": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["createVTTCueTemplate"]),
    "parseByteStream": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["parseByteStream"]),
    "parseResponse": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["parseResponse"]),
    "parseText": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["parseText"]),
    "parseTextStream": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["parseTextStream"]),
    "parseVTTTimestamp": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["parseVTTTimestamp"]),
    "renderVTTCueString": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["renderVTTCueString"]),
    "renderVTTTokensString": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["renderVTTTokensString"]),
    "tokenizeVTTCue": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["tokenizeVTTCue"]),
    "updateTimedVTTCueNodes": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["updateTimedVTTCueNodes"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/node_modules/media-captions/dist/dev.js [app-client] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$captions$2f$dist$2f$dev$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__ = __turbopack_context__.i("[project]/node_modules/media-captions/dist/dev.js [app-client] (ecmascript) <exports>");
}}),
}]);

//# sourceMappingURL=node_modules_media-captions_dist_cb689253._.js.map